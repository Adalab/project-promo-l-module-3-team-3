    ...
    <>
      <main className="main">
        <div className="main__content">
          <img className="main__content--logo" src={logo} alt="look like loop" title="Look Like Loop" />
          <h2 className="main__content--subtitle">Crea tu tarjeta de visita</h2>
          <p className="main__content--text">Crea mejores contactos profesionales de forma fácil y cómoda</p>
